 ...
 */
function bootswatch_post_classes( $classes ) {
...
add_filter( 'post_class', 'bootswatch_post_classes' );
 ...
 */
function bootswatch_edit_post_link( $output ) {
	$output = str_replace( 'class="post-edit-link"', 'class="post-edit-link btn btn-default"', $output );
	return $output;
}
add_filter( 'edit_post_link', 'bootswatch_edit_post_link' );
