...
function bootswatch_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'bootswatch' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
function bootswatch_scripts() {
	wp_enqueue_style( 'bootswatch-style', get_stylesheet_uri() );

	wp_enqueue_script( 'bootswatch-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'bootswatch-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
